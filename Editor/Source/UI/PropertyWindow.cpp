...
void FPropertyWindow::DrawStaticMeshComponentDetails(UStaticMeshComponent* MeshComponent, FEditorEngine* Engine)
{
	...
	TArray<FString> AllMaterialNames = MaterialManager.GetAllMaterialNames();
	...
	TArray<FString> MaterialNames = SelectedMaterialSource.empty()
		? AllMaterialNames
		: MaterialManager.GetMaterialNamesBySource(SelectedMaterialSource);
	...
	const bool bHasSelectableMaterials = !MaterialNames.empty();
